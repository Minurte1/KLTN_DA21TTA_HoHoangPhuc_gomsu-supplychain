  ...
  try {
    let query = `
      SELECT 
        ...
        m.ID_MATERIALS_, m.ID_MATERIAL_TYPES AS MATERIAL_MATERIAL_TYPE, m.QUALITY, m.NAME_ AS MATERIAL_NAME_, m.UNIT_, m.QUANTITY AS MATERIAL_QUANTITY, m.COST_PER_UNIT_, m.CREATED_AT_PRODUCTS AS MATERIAL_CREATED_AT, m.UPDATED_AT_PRODUCTS AS MATERIAL_UPDATED_AT, m.ORIGIN, m.EXPIRY_DATE, m.ID_COMPANY AS MATERIAL_COMPANY
    ...
    // Có thể ORDER BY pi.ID_PRODUCT_INSTANCE hoặc thứ tự khác tùy ý
