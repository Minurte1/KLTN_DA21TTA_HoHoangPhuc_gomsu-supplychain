...
const PermissionManagerModal = ({
  ...
  const reverseRouterName = (translatedName) => {
    const routerTranslations = {
      dashboard: "Bảng điều khiển",
      role: "Quản lý phân quyền (CC - VC - SX)",
      user: "Quản lý người dùng (CC - VC - SX)",
      company: "Quản lý công ty (CC - VC - SX)",
      company_type: "Quản lý loại công ty",
      product: "Sản phẩm ( SX )",
      category: "Danh mục sản phẩm ( SX )",
      material: "Nguyên vật liệu (CC - SX)",
      material_type: "Loại nguyên vật liệu (CC - SX)",
      material_order_master: "Đơn đặt hàng nguyên vật liệu (CC - SX)",
      material_order_master_pending: "Đơn nguyên vật liệu (Chờ duyệt) (CC)",
      material_order_master_buy_pending: "Đơn nguyên vật liệu (Chờ mua) (SX)",
      material_order_master_ship_confirmed:
        "Đơn nguyên vật liệu (Đã xác nhận vận chuyển) (VC)",
      material_order_master_seller_confirmed:
        "Đơn nguyên vật liệu (Người bán đã xác nhận) (CC)",
      order_item: "Đơn hàng (SX)",
      production_plans: "Kế hoạch sản xuất (SX)",
      production_steps: "Bước sản xuất (SX)",
      equipment: "Thiết bị (SX)",
      production_material: "Nguyên liệu sản xuất (SX)",
      product_instances: "Sản phẩm cụ thể (SX)",
      transport_orders: "Đơn vận chuyển (VC)",
      transport_service_fees: "Phí dịch vụ vận chuyển (VC)",
      transport_orders_delivered: "Đơn vận chuyển (Đã giao) (VC)",
      transport_orders_success: "Đơn vận chuyển (Thành công) (VC)",
      transport_orders_failed: "Đơn vận chuyển (Thất bại) (VC)",
    };
