...
const Transport_ordersShipDELIVERED = () => {
  ...
  const STATUS = "DELIVERED"; // hoặc null nếu muốn lấy tất cả
  useEffect(() => {
    fetchOrders();
  }, [userInfo]);
  ...
  return (
    <Box>
      <Typography variant="h5" gutterBottom mt={4}>
        Đơn hàng công ty vận chuyển vật liệu đã giao
      </Typography>
...
export default Transport_ordersShipDELIVERED;
