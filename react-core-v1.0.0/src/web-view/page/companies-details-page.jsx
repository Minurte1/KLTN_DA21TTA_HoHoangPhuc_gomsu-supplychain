      ...
      <Grid container spacing={3} mt={8}>
        ...
        <Grid item xs={12} lg={8}>
            ...
            <CardContent>
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  <Typography variant="body2">{company?.ID_COMPANY}</Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant="body2" color="textSecondary">
                    Loại công ty
          ...
          <Card className="mt-3">
            ...
            <CardContent>
              <Typography variant="body2" color="textSecondary">
                {company?.NAME_COMPANY} là một công ty chuyên về vận chuyển và
                logistics, cam kết mang đến dịch vụ chất lượng cao cho khách
                hàng...
              </Typography>
            </CardContent>
          </Card>
