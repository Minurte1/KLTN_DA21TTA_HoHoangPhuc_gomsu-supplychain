...
INSERT INTO `role` VALUES (1,'Quản trị viên','[\n  {\"router\": \"role\", \"actions\": [\"view\", \"create\", \"update\", \"delete\"]},\n  {\"router\": \"user\", \"actions\": [\"view\", \"create\", \"update\", \"delete\"]},\n  {\"router\": \"product\", \"actions\": [\"view\", \"create\", \"update\", \"delete\"]},\n  {\"router\": \"dashboard\", \"actions\": [\"access\"]},\n  {\"router\": \"order\", \"actions\": [\"view\", \"update\", \"ship\"]}\n]',0,'ADMIN'),(2,'Nhân viên kho','[\n  {\"router\": \"product\", \"actions\": [\"view\"]},\n  {\"router\": \"order\", \"actions\": [\"view\", \"update\"]}\n]',0,'WAREHOUSE'),(3,'Nhân viên bán hàng','[\n  {\"router\": \"order\", \"actions\": [\"view\", \"update\", \"ship\"]},\n  {\"router\": \"user\", \"actions\": [\"view\"]}\n]',0,'SALES'),(4,'Khách hàng','[\n  {\"router\": \"product\", \"actions\": [\"view\"]},\n  {\"router\": \"order\", \"actions\": [\"view\"]}\n]',1,'CUSTOMER'),(6,'asdasdasdas','',NULL,'dasdasd'),(7,'áda','',NULL,'dasdasd'),(8,'áda','',NULL,'sdasdasd'),(9,'áda111','',NULL,'ádasd11'),(10,'asdasd','',1,'asdasd'),(13,'LIST_PERMISION','\"[{\\\"router\\\":\\\"role\\\",\\\"actions\\\":[\\\"view\\\",\\\"create\\\",\\\"update\\\",\\\"delete\\\"]},{\\\"router\\\":\\\"user\\\",\\\"actions\\\":[\\\"view\\\",\\\"create\\\",\\\"update\\\",\\\"delete\\\"]},{\\\"router\\\":\\\"product\\\",\\\"actions\\\":[\\\"view\\\",\\\"create\\\",\\\"update\\\",\\\"delete\\\"]},{\\\"router\\\":\\\"dashboard\\\",\\\"actions\\\":[\\\"access\\\"]},{\\\"router\\\":\\\"order\\\",\\\"actions\\\":[\\\"view\\\",\\\"update\\\",\\\"ship\\\"]}]\"',0,'LIST_PERMISION');
...
-- Dump completed on 2025-05-05 23:00:24
